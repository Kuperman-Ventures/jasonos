// Parse a morning-brief job-alert bullet into role title, company, and salary.

export interface ParsedOpportunity {
  /** Clean role title for display. */
  roleTitle: string;
  company: string | null;
  salary: string | null;
  /** Original harvested line (link text + trailing prose). */
  rawTitle: string;
}
...
/**
 * Turn a harvested opportunity line into structured fields when the morning
 * brief (from email scans) includes them.
 */
