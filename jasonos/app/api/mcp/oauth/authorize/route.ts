...
function loginForm(params: URLSearchParams, error?: string) {
  ...
  return `
    ...
    <p>Paste the JasonOS password from Settings → Cursor &amp; Claude. This lets Claude read JasonOS and publish the morning brief and inbox dispatch. Same password Cursor uses.</p>
